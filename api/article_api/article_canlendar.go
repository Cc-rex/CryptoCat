...
// @Success 200 {array} CalendarResponse "A list of dates and the count of articles published on each date."
// @Failure 400 {object} resp.Response{} "Invalid query parameters"
// @Failure 500 {object} resp.Response{} "Failed to retrieve data due to internal server error"
